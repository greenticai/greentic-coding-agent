...
- **Path:** `.codex/done/PR-*.md`, `.codex/global_rules.md`, `.codex/repo_overview_task.md`
  - **Role:** Codex planning and repo-maintenance instructions.
  - **Key functionality:** Preserve the implemented staged roadmap and require ongoing maintenance of `.codex/repo_overview.md` plus `ci/local_check.sh` validation for future PR-style work.
  - **Key dependencies / integration points:** `.codex/done/` preserves the implemented historical PR slices. There are currently no active `.codex/PR-*.md` roadmap files.
